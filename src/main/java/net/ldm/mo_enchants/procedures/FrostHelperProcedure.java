...
public class FrostHelperProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (EnchantmentHelper.getItemEnchantmentLevel(MoEnchantsEnchantments.FROST.get(),
		...
		} else if (EnchantmentHelper.getItemEnchantmentLevel(MoEnchantsEnchantments.FROST.get(),
